      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 gap-5">
        <div className="rounded-card bg-white/[0.04] border border-gold/[0.08] w-full p-6 space-y-4 text-center">
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="font-sans text-[12px] text-green-400/70 tracking-widest uppercase">
              ไม่พบสิ่งผิดปกติ
            </span>
          </div>
          ...
          {result.reason && (
            <p className="font-sans text-[12px] text-dim/40 italic leading-relaxed border-t border-dim/10 pt-3">
              "{result.reason}"
            </p>
          )}

          <div className="border-t border-dim/10 pt-3">
            <p className="font-sans text-[12px] text-dim/35 tracking-widest">
    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6 gap-5">
      <div className="rounded-card bg-white/[0.04] border border-blood/[0.2] w-full p-6 space-y-4 text-center">
        <div className="flex items-center justify-center gap-2">
          ...
          <span className="font-sans text-[12px] text-blood/70 tracking-widest uppercase">
            ตรวจพบสิ่งผิดปกติ
          </span>
        </div>
